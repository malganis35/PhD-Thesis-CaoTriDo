...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\linewidth]{Example2_temporal}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.55\linewidth]{Example2_frequency}
...
\begin{figure}[h!]
	...
	\includegraphics[width=0.85\linewidth]{images/DTWwarpedSignals}
