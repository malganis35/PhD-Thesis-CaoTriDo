...
\begin{figure}[h!]
	\centering
	\subfloat[]{\includegraphics[width = 3in]{Stand_m2tml_2}}
	\subfloat[]{\includegraphics[width = 3in]{behavior_m2tml_2}}\
	\subfloat[]{\includegraphics[width = 3in]{no_warp_m2tml_2}}
	\subfloat[]{\includegraphics[width = 3in]{Unimod_m2tml_2}} \
	\subfloat[]{\includegraphics[width = 3in]{freq_m2tml_2}} 	\subfloat[]{\includegraphics[width = 3in]{apriori_m2tml_2}}\	   
...
\begin{table}[h!]
	...
	\resizebox{1\textwidth}{!}{
		...
		\begin{tabular}{| c |  l l l l l |}
			...
			\\		
			BME 				& $d_{B}^0$ (75.2\%)&   $d_F^4$ (15.5\%)&   $d_{B}^2$ (5.8\%)&   $d_{B}^1$ (1.9\%)&   $d_F^1$ (0.7\%)   
			\\	
...
%	\subfloat[SonyAIBO]{\includegraphics[width = 3in]{SonyAIBO_weight_V2}} \
	\subfloat[SonyAIBO]{\includegraphics[width = 3.5in]{SonyAIBORobotSurface_NoDelay_bar2}} \
	\subfloat[Beef]{\includegraphics[width = 3.5in]{Beef_NoDelay_bar2}}\    
	\subfloat[CinC ECG torso]{\includegraphics[width = 3.5in]{CinC_ECG_torso_NoDelay_bar2}} \
	\subfloat[FaceFour]{\includegraphics[width = 3.5in]{FaceFour_DTW_bar2}} 
...
\begin{figure}[h!]
	...
	\subfloat[FaceFour]{\includegraphics[width = 2.7in]{FaceFour_DTW_TS2}} 
...
\begin{figure}[h!]
	...
	\subfloat[FaceFour ($D$, stress: 18,9\%)]{\includegraphics[width = 3in]{FaceFourALL_D_Delay_3}} \  
